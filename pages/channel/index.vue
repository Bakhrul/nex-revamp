<template>
    <div>
        ...
        <section class="my-2">
            <div class="container-fluid">
                <div class="title-section">Channel</div>
        ...
        <section class="my-5">
            <div class="container-fluid">
                <div class="row mb-3">
                    <div class="col-lg-12 mb-3 d-flex flex-wrap">
                        ...
                        <div class="dropdown me-3 mb-3">
                            <button class="btn btn-secondary dropdown-toggle text-left"
                                ...
                                type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <span>
                                <span style="font-size:13px;">Kategori</span><br>
                        ...
                        <div class="dropdown me-3 mb-3">
                            <button class="btn btn-secondary dropdown-toggle text-left"
                                ...
                                type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <span>
                                <span style="font-size:13px;">Channel</span><br>
...
<script setup>
    import backgroundImage from "~/assets/header-channel.png"
</script>