    ...
    <div>
        <div style="border-bottom:1px black solid">
            <div class="container-fluid">
                <img src="~/assets/logo-nex.png" class="mb-3 mt-3" style="width:100px" />
            </div>
        </div>
        <nav class="navbar navbar-expand-lg navbar-custom">
            <div class="container-fluid">
                <nuxt-link to="/" class="navbar-brand">
                    <img src="~/assets/special-deals.png" style="width:80px" />
                </nuxt-link>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><nuxt-link class="dropdown-item" to="/receiver">Receiver</nuxt-link></li>
                                <li><nuxt-link class="dropdown-item" to="/paket">Paket</nuxt-link></li>
                                <li><nuxt-link class="dropdown-item" to="/channel">Channel</nuxt-link></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="#">Tiktok Shop</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <nuxt-link class="dropdown-item" to="/news/sports">Sports</nuxt-link>
                                </li>
                                <li>
                                    <nuxt-link class="dropdown-item" to="/news/family">Family & Entertainment
                                    </nuxt-link>
                                </li>
                                <li>
                                    <nuxt-link class="dropdown-item" to="/news/national">Tv National</nuxt-link>
                                </li>
                                <li>
                                    <nuxt-link class="dropdown-item" to="/news/kids">Kids</nuxt-link>
                                </li>
                                <li>
                                    <nuxt-link class="dropdown-item" to="/news/anime">Anime</nuxt-link>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <nuxt-link to="/tentang-kami" class="dropdown-item">Company Profile</nuxt-link>
                                </li>
                                <li>
                                    <nuxt-link to="/faq" class="dropdown-item">FAQ</nuxt-link>
                                </li>
                            </ul>
                        </li>
                    </ul>
        ...
        <div
            :style="`background-image:url('${backgroundImage}');background-size: cover;background-repeat:no-repeat;min-height:300px`">
        </div>
        <section class="my-2">
            <div class="container-fluid">
                <div class="title-section">NexNews</div>
                <div class="subtitle-section"> Yang Paling Update dari Nex!</div>
            </div>
        </section>
        <section class="my-3">
            <div class="container d-flex justify-content-center">
                <div style="max-width:850px" class="w-100">
                    <div class="row">
                        <div class="col-lg-4 mb-3">
                            <nuxt-link to="/news/family">
                                <div class="news-filter" :class="route.params.id == 'family' ? 'active' : ''">Family Entertainment</div>
                            </nuxt-link>
                        </div>
                        <div class="col-lg-4 mb-3">
                            <nuxt-link to="/news/sports">
                                <div class="news-filter" :class="route.params.id == 'sports' ? 'active' : ''">Sports</div>
                            </nuxt-link>
                        </div>
                        <div class="col-lg-4 mb-3">
                            <nuxt-link to="/news/national">
                                <div class="news-filter" :class="route.params.id == 'national' ? 'active' : ''">TV National</div>
                            </nuxt-link>
                        </div>
                        <div class="col-lg-4 mb-3">
                            <nuxt-link to="/news/kids">
                                <div class="news-filter" :class="route.params.id == 'kids' ? 'active' : ''">Kids</div>
                            </nuxt-link>
                        </div>
                        <div class="col-lg-4 mb-3">
                            <nuxt-link to="/news/nex">
                                <div class="news-filter" :class="route.params.id == 'nex' ? 'active' : ''">Nex News</div>
                            </nuxt-link>
                        </div>
                        <div class="col-lg-4 mb-3">
                            <nuxt-link to="/news/anime">
                                <div class="news-filter" :class="route.params.id == 'anime' ? 'active' : ''">Anime</div>
                            </nuxt-link>
                        </div>
                    </div>
                </div>
        ...
        <section>
            <div class="container-fluid">
                <div class="row">
                <div class="col-lg-3 mb-3" v-for="a in 6">
                    <div class="shadow-product w-100 product-box">
                        ...
                        <div class="p-3 d-flex justify-content-center footer" style="border-top:1px #ddd solid">
                            <a href="javascript:void(0)">Baca Sekarang <i style="color:black;"
...
<script setup>
    import backgroundImage from "~/assets/header-news.png"
