<template>
    <div>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <nuxt-link class="dropdown-item" to="/paket">Paket</nuxt-link>
                                </li>
                                <li>
        ...
        <section class="my-5">
            <div class="container-fluid">
                <div class="title-section">Receiver Nex</div>
                <div class="subtitle-section">Beli & Aktivasi Sekarang, Banyak Untungnya!</div>
            </div>
        </section>
        <section class="my-2">
                ...
                <div class="slider-receiver">
                    <div style="width:320px">
                        <div class=" product-box"
                            style="border:0 !important;border-bottom:1px black solid !important;border-radius:0 !important;min-height:530px">
                            <img src="~/assets/receiver.png" style="width:90%;height: unset !important"/>
                            <div class="p-3 d-flex flex-column justify-content-center align-items-center"
                                style="min-height:120px">
                                <div class="fw-bold text-center fs-5" style="color:#00539B;">Nex Parabola</div>
                                <div class="text-center fs-6" style="color:#00539B;">Tipe Biru</div>
                                <div class="text-center" style="font-size:14px;color:#00539B">Lebih canggih tampilan
                                    baru</div>

                            </div>
                            <div class="p-3 d-flex justify-content-center footer">
                                <a href="javascript:void(0)" style="color:black;font-weight:500">Beli Sekarang <i
                                        style="color:black;" class="bi bi-chevron-right"></i></a>
                            </div>
                        </div>
                        <img class="mt-3" src="~/assets/feature-receiver.png" />
                    </div>
                    <div style="width:320px">
                        <div class=" product-box"
                            style="border:0 !important;border-bottom:1px black solid !important;border-radius:0 !important;min-height:530px">
                            <img src="~/assets/receiver-2.png" style="width:90%;height: unset !important"/>
                            <div class="p-3 d-flex flex-column justify-content-center align-items-center"
                                style="min-height:120px">
                                <div class="fw-bold text-center fs-5" style="color:#00539B;">Nex Parabola</div>
                                <div class="text-center fs-6" style="color:#00539B;">Tipe Biru</div>
                    ...
                    <div style="width:320px">
                        <div class=" product-box"
                            style="border:0 !important;border-bottom:1px black solid !important;border-radius:0 !important;min-height:530px">
                            <img src="~/assets/receiver-3.png" style="width:90%;height: unset !important"/>
                            <div class="p-3 d-flex flex-column justify-content-center align-items-center"
                                style="min-height:120px">
                                <div class="fw-bold text-center fs-5" style="color:#00539B;">Nex Parabola</div>
                                <div class="text-center fs-6" style="color:#00539B;">Tipe Biru</div>
...
<script setup>
    import backgroundImage from "~/assets/header-receiver.png"
    onMounted(() => {
        initSlider()        
    });
