    ...
    <template v-if="error.statusCode  == 404">
        ...
        <div class="container">
            <h3 class="text-center text-white pt-3"
                style="max-width:600px;font-weight: bold;display:block;margin:auto;">Oops! Halaman yang kamu cari nggak
                ada... persis kayak trofi Premier League-nya Tottenham.</h3>
            <div class="text-center text-white pt-3" style="max-width:500px;display:block;margin:auto;">Sama kaya fans
                Spurs yang nyari trofi Premier League, kamu juga udah nyari halaman ini, tapi tetap nggak ketemu.</div>
            <div class="footer-404 mt-5">
                <div class="row">
                    <div class="col-6 text-white pt-3 pb-3">PT Mediatama Televisi</div>
                    <div class="col-6">
                        <div class="d-flex flex-wrap justify-content-end">
                            <a class="mt-3 mb-3 me-2" href="https://www.tiktok.com/@nexparabola_tv"><svg width="15" height="15" viewBox="0 0 15 15" fill="none"
...
<path d="M7.5 0C3.35786 0 0 3.35786 0 7.5C0 11.6421 3.35786 15 7.5 15C11.6421 15 15 11.6421 15 7.5C15 3.35786 11.6421 0 7.5 0ZM5.09965 11.2109V3.78905L11.6582 7.56313L5.09965 11.2109Z" fill="#CDCDCD"/>
</g>
<defs>
        ...
        <div class="container">
            ...
            <div class="footer-500 mt-5">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="d-flex flex-wrap justify-content-end">
                            <a class="mt-3 mb-3 me-2" href="https://www.tiktok.com/@nexparabola_tv"><svg width="15"
