                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-7 mb-5">
                            ...
                            <div class="d-flex align-items-center">
                                <NuxtImg loading="lazy" format="webp" src="/sample-qr.png" alt="qr" class="me-2" style="max-width:80px"/>
                                <a class="w-100"
                                    href="https://play.google.com/store/apps/details?id=ezlink.project.nexparabola&pli=1"><NuxtImg loading="lazy" format="webp"
