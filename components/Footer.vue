            ...
            <div class="row">
                <div class="col-lg-3 col-5">
                    ...
                    <ul style="font-size:16px">
                        <li>
                            <nuxt-link to="/paket" class="footer-link">Produk</nuxt-link>
                        </li>
                        <li>
                            <nuxt-link to="/channel" class="footer-link">Channel</nuxt-link>
                        </li>
                        <li>
                            <nuxt-link to="/special-deals" class="footer-link">Promo</nuxt-link>
                        </li>
                        <li>
                ...
                <div class="col-lg-5 col-7">
                    <div class="show-on-desktop">
                        ...
                        <div class="d-flex flex-wrap mb-5" style="font-size: 24px">
                            <div class="me-2"><a href="https://id-id.facebook.com/groups/180272675720045/"
                                    ...
                                    <NuxtImg format="webp" src="/icon/facebook.svg" alt="facebook" style="width:29px" />
                                </a>
                            </div>

                            <div class="me-2"><a href="https://x.com/nexofficialtv?s=21"
                                    style="color:black;text-decoration: none !important">
                                    <NuxtImg format="webp" src="/icon/twitter.svg" alt="twitter" style="width:29px" />
                                </a>
                            </div>
                            <div class="me-2"><a href="https://z-p42.www.instagram.com/nexparabola_tv/?hl=da"
                                    style="color:black;text-decoration: none !important">
                                    <NuxtImg format="webp" src="/icon/instagram.svg" alt="instagram" style="width:29px" />
                                </a>
                            </div>

                            <div class="me-2"><a href="https://www.tiktok.com/@nexparabola_tv"
                                    style="color:black;text-decoration: none !important">
                                    <NuxtImg format="webp" src="/icon/tiktok.svg" alt="tiktok" style="width:29px" />
                                </a>
                            </div>
                            <div><a href="https://www.youtube.com/c/OfficialNexParabolaTV"
                                    style="color:black;text-decoration: none !important">
                                    <NuxtImg format="webp" src="/icon/youtube.svg" alt="youtube" style="width:29px" />
                                </a>
                            </div>
                    ...
                    <ul style="font-size:16px" class="mb-1">
                        <li><a href="mailto:cs@nexparabola.co.id" class="footer-link"> <NuxtImg format="webp" alt="email"
                                    src="/icon/email.svg" style="width:29px" />
                                &ensp;cs@mynex.co.id</a></li>
                        <li><a href="https://wa.me/6281260012700" class="footer-link"> <NuxtImg format="webp"
                                    src="/icon/whatsapp.svg" alt="whatsapp" style="width:29px" />
                                &ensp;+62 81260012700</a></li>
                        <li><a href="tel:02180637388">
                                <div class="footer-link d-flex align-items-start"> <NuxtImg format="webp" src="/icon/phone.svg" alt="phone"
                                        style="width:29px" />
                        ...
                        <li><a href="https://maps.app.goo.gl/7hR2qqfsMb1zGKK97" class="footer-link"> <NuxtImg format="webp" src="/icon/location.svg" alt="location"
                                    style="width:29px" />
                                &ensp;PT Mediatama Televisi</a></li>
                    </ul>
                    <div class="show-on-mobile">
                        <div class="footer-title">Ikuti Kami di </div>
