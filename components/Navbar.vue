<template>
    <div class="hide-on-mobile"
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <router-link to="/">
                    <NuxtImg format="webp" src="/logo-nex.svg" alt="logo-nex" class="mb-3 mt-3" style="width:130px" />
                </router-link>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        <div class="container">
            <div class="border-bottom-mobile-nav justify-content-between align-items-center w-100 py-2 show-nav-mobile">
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" @click="toggleNav()"
                    ...
                    <svg v-if="showNav" width="23" height="23" viewBox="0 0 33 33" fill="none"
                ...
                <router-link to="/">
                    <NuxtImg format="webp" src="/logo-nex.svg" alt="logo-nex" style="width:80px" />
                </router-link>
                <div>
                ...
                <ul class="navbar-nav me-auto ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item nav-item-spesial-deals">
                        <router-link to="/special-deals" class="nav-link">
                            <NuxtImg format="webp" src="/special-deals.svg" alt="special-deals" class="show-on-desktop" style="width:65px" />
